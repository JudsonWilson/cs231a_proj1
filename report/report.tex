...
%% V1.0
%% 2014/03/15
%% by Christian Elder, Judson Wilson, Tony Vivoli
%% This is the final report for CS231a (Winter 2014) project.
...
%Placed here to get on the correct page, but belong with results section.
	\begin{figure}
		\centering
