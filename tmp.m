...
plot_poly(cameras(3).gen.fov_poly_world);
axis equal;
...
% as (x,y,theta)
relative_camera_position_votes_12 = zeros(0,3);
relative_camera_position_votes_13 = zeros(0,3);
relative_camera_position_votes_23 = zeros(0,3);
...
for i=1:length(correspondences_lists)
    ...
    for p=1:size(correspondence_pairs,1)
        ...
        if tracklets{pair_indices(1)}.cam_num ~= tracklets{pair_indices(2)}.cam_num
            ...
            if ~isnan(x)
                if tracklets{pair_indices(1)}.cam_num == 1
                    if tracklets{pair_indices(2)}.cam_num == 2
                        relative_camera_position_votes_12 = [relative_camera_position_votes_12; x y theta];
                    else
                        relative_camera_position_votes_13 = [relative_camera_position_votes_13; x y theta];
                    end
                else
                    relative_camera_position_votes_23 = [relative_camera_position_votes_23; x y theta];
                end
            end
        end
    end
...
plot3(relative_camera_position_votes_12(:,1), ...
      relative_camera_position_votes_12(:,2), ...
      relative_camera_position_votes_12(:,3),'o');
hold on;
...
plot3(relative_camera_position_votes_13(:,1), ...
      relative_camera_position_votes_13(:,2), ...
      relative_camera_position_votes_13(:,3),'o');
hold on;
...
plot3(relative_camera_position_votes_23(:,1), ...
      relative_camera_position_votes_23(:,2), ...
      relative_camera_position_votes_23(:,3),'o');
hold on;
...
% correct)
mean_vote_12 = [      mean(relative_camera_position_votes_12(:,1)), ...
                      mean(relative_camera_position_votes_12(:,2)), ...
                mean_angle(relative_camera_position_votes_12(:,3))]
mean_vote_13 = [      mean(relative_camera_position_votes_13(:,1)), ...
                      mean(relative_camera_position_votes_13(:,2)), ...
                mean_angle(relative_camera_position_votes_13(:,3))]
mean_vote_23 = [      mean(relative_camera_position_votes_23(:,1)), ...
                      mean(relative_camera_position_votes_23(:,2)), ...
                mean_angle(relative_camera_position_votes_23(:,3))]
...
% coordinate space).
params_12 = estimate_parameters(relative_camera_position_votes_12,200,1)
params_13 = estimate_parameters(relative_camera_position_votes_13,200,1)
params_23 = estimate_parameters(relative_camera_position_votes_23,200,1)
